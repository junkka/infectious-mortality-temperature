...
crb2 <- crossbasis(
  exposures, 
  lag = 13, 
  argvar =  list(fun = "ns", df = 3) ,# list(fun = "thr", side = "d", thr.value =cent), #list(fun= "ns", df = 3),
  arglag = list(fun = "ns", knots = logknots(1:13, df = 4))#list(fun = "ns", df =3 ) #list(fun= "strata", df = 3)
)
